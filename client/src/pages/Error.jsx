...
const Error = () => {
  ...
  if(error.status === 404) {
    return (
      <div className="min-h-[100vh] text-center flex flex-col justify-center items-center">
        <img src={pageNotFound} className="w-[90vw] max-w-[600px]" alt="404 page not found"/>
        ...
        <Link to="/dashboard" className="btn-main py-4 px-6">Go home</Link>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-[100vh] text-center flex flex-col justify-center items-center">
      <img src={serverDown} className="w-[90vw] max-w-[600px]" alt="An Error has Occurred"/>
