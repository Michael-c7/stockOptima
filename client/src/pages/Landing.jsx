...
import img123 from "../assets/images/avatar-2.jpg"
      ...
      <div className='sm:max-w-4xl max-w-full text-center'>
        <div className='sm:mx-8 mx-0'>
          ...
          <div className='p-4 flex justify-center items-center flex-col sm:flex-row sm:space-x-4 space-x-0 space-y-4 sm:space-y-0'>
            <Link to="/register" className='bg-green-500 p-4 text-white rounded-sm'>
            Register
            </Link>
            <Link to="login" className='bg-green-500 p-4 text-white rounded-sm'>
            Login / demo user
            </Link>
          </div>
        </div>
